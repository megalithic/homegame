...
set :scm,             :git
set :repository,      "git@github.com:megalithic/homegame.git"
set :branch,          "origin/master"
set :migrate_target,  :current
set :ssh_options,     { :forward_agent => true, :port => 30000 }
set :rails_env,       "production"
set :deploy_to,       "/home/deploy/apps/homegame"
...
role :web,    "173.230.142.85"
role :app,    "173.230.142.85"
role :db,     "173.230.142.85", :primary => true
